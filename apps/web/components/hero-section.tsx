...
export default function HeroSection() {
  const [state, handleSubmit] = useForm("mqabdoze");

  const inputRef = useRef<HTMLInputElement>(null);

  useEffect(() => {
    if (state.succeeded && inputRef.current) {
  ...
  return (
    <>
      <HeroHeader />
      {/** biome-ignore lint/nursery/useUniqueElementIds: This is intentional */}
      <main className="overflow-hidden" id="about">
        <div
          aria-hidden
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  The best way to manage your money, investments, expenses and
                  retirement planning.
                </TextEffect>
